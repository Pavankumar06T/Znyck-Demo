    ...
    useEffect(() => {
        const loadTransactions = async () => {
            ...
            try {
                ...
                // Client-side filtering (ideally backend)
                                    ...
                                    <tr key={i} className="hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center space-x-2">
                                                <div className={`p-1 rounded-md ${tx.type === 'subscription' ? 'bg-purple-500/10 text-purple-400' : 'bg-blue-500/10 text-blue-400'}`}>
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${tx.status === 'succeeded' ? 'bg-green-500/20 text-green-400' :
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-400">
                                            ...
                                            <div className="text-xs text-gray-600">{new Date(tx.createdAt).toLocaleTimeString()}</div>
                                        </td>
                                    </tr>
                                ))
                            )}
